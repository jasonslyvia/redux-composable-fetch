...
exports.applyFetchMiddleware = undefined;
...
var _jsonpFetch = require('./jsonpFetch');

var _jsonpFetch2 = _interopRequireDefault(_jsonpFetch);
...
function createFetchMiddleware() {
  ...
  var _finalConfig$promiseM = finalConfig.promiseMode,
      promiseMode = _finalConfig$promiseM === undefined ? false : _finalConfig$promiseM,
      _finalConfig$rejectHa = finalConfig.rejectHard,
      rejectHard = _finalConfig$rejectHa === undefined ? false : _finalConfig$rejectHa;
  var _options$beforeFetch = options.beforeFetch,
      beforeFetch = _options$beforeFetch === undefined ? defaultBeforeFetch : _options$beforeFetch,
      _options$afterFetch = options.afterFetch,
      afterFetch = _options$afterFetch === undefined ? defaultAfterFetch : _options$afterFetch,
      _options$onReject = options.onReject,
      onReject = _options$onReject === undefined ? rejectHandler : _options$onReject,
      _options$onResolve = options.onResolve,
      onResolve = _options$onResolve === undefined ? resolveHandler : _options$onResolve;
    ...
    return function () {
      ...
      return function (action) {
        ...
        return beforeFetchResult.then(function (args) {
          ...
          var url = action.url,
              types = action.types,
              useJsonp = action.useJsonp,
              options = _objectWithoutProperties(action, ['url', 'types', 'useJsonp']); // eslint-disable-line
