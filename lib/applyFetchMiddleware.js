...
function applyFetchMiddleware() {
  ...
  return {
    ...
    onResolve: function onResolve(_ref7) {
      ...
      return middlewaresWithOnResolve[0] ? middlewaresWithOnResolve[0].onResolve.call(null, { action: action, type: type, payload: payload, error: error }) : undefined;
    }
  };
}